...
def test_can_create_one_user(api_client: APIClient, admin: UserModel):
...
# def test_can_edit_user(api_client: APIClient, admin: UserModel):
#     user = UserFactory()
...
def test_can_view_all_users(api_client: APIClient, admin: UserModel):
...
def test_can_view_one_user(api_client: APIClient, admin: UserModel):
    user = UserFactory()
...
def test_can_delete_user(api_client: APIClient, admin: UserModel):
    user = UserFactory()
